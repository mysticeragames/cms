...
[![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/mysticeragames/MakeItStatic-CMS/docker-image-release.yml?event=release&label=Docker%20Release)](https://github.com/mysticeragames/MakeItStatic-CMS/actions/workflows/docker-image-release.yml)
